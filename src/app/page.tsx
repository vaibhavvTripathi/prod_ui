...
const Index = () => {
  ...
  // useEffect(() => {
  //   sendMessage(
  //     "create any app you like and in this response please include all codexity steps (codexity-write codexity-rename codexity-add dependency)"
  //   );
  // }, [sendMessage]);
  // const { fileTree } = useFileSystemWithTemplate();
